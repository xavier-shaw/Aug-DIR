...
Write and submit ~0.5-1p of notes for each user research session OR initial analysis of survey results
...
[+2] Synthesize your user research into: Michael
[+1] Personas + Scenarios (at least one persona, one scenario)
...
[+1] Articulate a problem statement.
...
[+1] Storyboard of how your proposed system could address the core problem. This is where you begin to imagine a prototype to address the core problem you identified.

DEPTH (optional, not required) [+1]:
...
Intentions:
Skim for Overview – Quickly grasp the main idea and decide relevance.
Comprehend Key Concepts – Build a solid understanding of the central theories, methods, or results.
Retrieve Specific Information – Locate targeted details like data, equations, or results.
Critical Assess – Evaluate the paper’s validity, originality, and contribution.
Utilizing Knowledge – Use the information to solve problems, replicate methods, or inform research.
Synthesize Ideas – Connect the content to existing knowledge and generate new insights.
...
Conduct a different interview about specific questions of our problem statement
